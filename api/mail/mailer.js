  ...
  async test() {
    try {
      ...
      this.mail(
        "BenFlix Test Email",
        "This is a test",
        "If you're seeing this email then your BenFlix email settings are correct!",
        false,
        [this.adminEmail]
      );
        ...
        setTimeout(async () => {
          ...
          try {
            await this.transport.sendMail({
              from: `"BenFlix" <${this.config.emailFrom}>`,
              to: `${username} <${send}>`,
              bcc: this.adminEmail,
              subject: subject,
